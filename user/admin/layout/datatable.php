	...
	<script src="<?php echo base_url(); ?>assets/pages/data-table/extensions/buttons/js/dataTables.buttons.min.js"></script>
	<script src="<?php echo base_url(); ?>assets/pages/data-table/extensions/buttons/js/buttons.flash.min.js"></script>
	<script src="<?php echo base_url(); ?>assets/pages/data-table/extensions/buttons/js/jszip.min.js"></script>
	<script src="<?php echo base_url(); ?>assets/pages/data-table/extensions/buttons/js/vfs_fonts.js"></script>
	<script src="<?php echo base_url(); ?>assets/pages/data-table/extensions/buttons/js/buttons.colVis.min.js"></script>
	...
	<script src="<?php echo base_url(); ?>assets/pages/data-table/js/dataTables.bootstrap4.min.js"></script>
