            ...
            <div class="inner">
                ...
                <div class="row"style = "background-color:lightgrey">
					...
					<div class="panel panel-default">
                        ...
                        <div class="panel-body"style = "background-color:#4c9bfd;">

                            <div class="table-responsive">

                                <table class="table table-striped table-bordered table-hover" id="dataTables-example"style = "background-color:#fbb4b4">
...
?>                     
            ...
            <div class="well text-center"style = "background-color:#fbb4b4">
